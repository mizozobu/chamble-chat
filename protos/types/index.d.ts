...
export namespace app {
  ...
  class AppController extends $protobuf.rpc.Service {
     ...
     */
    public accumulate(
      request: app.INumberArray,
      callback: app.AppController.AccumulateCallback,
    ): void;
     ...
     * @param callback Node-style callback called with the error, if any, and SumOfNumberArray
     */
    public accumulateStream(
      request: app.INumberArray,
      callback: app.AppController.AccumulateStreamCallback,
    ): void;
     ...
     * @param callback Node-style callback called with the error, if any, and SumOfNumberArray
     */
    public accumulateStreamPass(
      request: app.INumberArray,
      callback: app.AppController.AccumulateStreamPassCallback,
    ): void;
  ...
  namespace AppController {
     ...
     * @param [response] SumOfNumberArray
     */
    type AccumulateStreamPassCallback = (
      error: Error | null,
      response?: app.SumOfNumberArray,
    ) => void;
  }
  ...
  class SumOfNumberArray implements ISumOfNumberArray {
     ...
     */
    public static create(
      properties?: app.ISumOfNumberArray,
    ): app.SumOfNumberArray;
